...
class SubmissionProfileElementTest < ActiveSupport::TestCase
  ...
  setup do
    @instance = submission_profile_elements(:southeast_default_title)
  ...
  test "create() updates indexes in the owning profile" do
    reg_element = RegisteredElement.create!(institution: institutions(:southeast),
                                            name:        "newElement",
                                            label:       "New Element")
    profile = submission_profiles(:southeast_default)
  ...
  test "position is required" do
    assert_raises ActiveRecord::RecordInvalid do
      SubmissionProfileElement.create!(submission_profile: submission_profiles(:southeast_default),
  ...
  test "registered_element is required" do
    assert_raises ActiveRecord::RecordInvalid do
      SubmissionProfileElement.create!(position: 0,
                                       submission_profile: submission_profiles(:southeast_default))
    end
  end
